...
# Setup script for NewRelic AI Agent Action

echo "🚀 Setting up NewRelic AI Agent Action..."

# Create lib directory
echo "📁 Creating lib directory..."
mkdir -p lib

# Create lib/context_loader.rb
echo "📝 Creating lib/context_loader.rb..."
cat > lib/context_loader.rb << 'EOF'
module ContextLoader
  def self.load_context
    claude_md_path = File.join(__dir__, '../claude.md')
    
    unless File.exist?(claude_md_path)
      puts "⚠️  Warning: claude.md not found, using minimal context"
...
# Create lib/tools.rb
echo "📝 Creating lib/tools.rb..."
cat > lib/tools.rb << 'EOF'
class Tools
...
echo ""
echo "📋 Next steps:"
echo "1. Edit claude.md and add your Azure DevOps platform configuration"
echo "2. Run 'bundle install' to install dependencies"
echo "3. Test locally or push to use in GitHub Actions"
